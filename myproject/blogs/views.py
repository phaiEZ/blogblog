...
def blogDetail(request, id):
    ...
    popular = Blogs.objects.all().order_by('-views')[:3]
    suggestion = Blogs.objects.all().order_by('views')[:3]
    return render(request, "frontend/blogDetail.html", {"blog": singleBlog, "popular": popular, "categories": categories, 'suggestion': suggestion})
...
def searchCategory(request, cat_id):
    ...
    return render(request, "frontend/searchCategory.html", {"blogs": blogs, "popular": popular, "categories": categories, 'suggestion': suggestion, 'categoryName': categoryName})
...
def searchWriter(request, writer):
    ...
    popular = Blogs.objects.all().order_by('-views')[:3]
    suggestion = Blogs.objects.all().order_by('views')[:3]
    return render(request, "frontend/searchWriter.html", {"blogs": blogs, "popular": popular, "categories": categories, 'suggestion': suggestion, 'writer': writer})
